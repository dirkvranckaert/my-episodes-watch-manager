package eu.vranckaert.android.viewholder;
 ...
 */
public abstract class AbstractRecyclerViewHolder extends ViewHolder {
     ...
     */
    public AbstractRecyclerViewHolder(Context context, int layoutResource) {
     ...
     * @param layoutResource
     */
    public AbstractRecyclerViewHolder(Context context, ViewGroup parent,
                                      int layoutResource) {
        this(LayoutInflater.from(context), parent, layoutResource);
    }

    public AbstractRecyclerViewHolder(LayoutInflater inflater, ViewGroup parent,
                                      int layoutResource) {
    ...
    protected int getIdForView(View view) {
        return view.getId();
    }
    ...
    @SuppressWarnings("unchecked")
    public static <T extends AbstractRecyclerViewHolder> T fromView(View v) {
        if (v != null) {
            return (T) v.getTag();
        }
        return null;
